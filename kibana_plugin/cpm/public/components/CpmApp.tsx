...
export function CpmApp({ core }: Props) {
  ...
  return (
    <EuiPage paddingSize="l" restrictWidth={false}>
      <EuiPageBody component="div">
        <EuiPageHeader
          pageTitle="Cluster Pipeline Manager"
          description="Manage cluster registry, scoring weights, stream locks, and watcher execution."
        />
        ...
        {activeTab === 'locks' && (
          <StreamLocksTab api={api} notifications={core.notifications} />
        )}
